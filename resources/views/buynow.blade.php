...
@php
    $total = 0;
    foreach ($data as $d) {
        $total += $d->quantity * floatval($d->textsthree);
    }
@endphp
    ...
    <span style='float:right; text-align:right;'>
        ...
        <div class='credit-info'>
          <div class='credit-info-content'>
            ...
            <form action="{{url('')}}/buynow" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <table class="half-input-table">
        <tr>
            ...
            <td>
                ...
                <input type="text" id="phone" class="input-field" name="phone" required>
            </td>
        </tr>
    </table>
    
    <input type="submit" class="pay-btn" value="Order">
